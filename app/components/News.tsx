...
export default function News() {
  return (
    <section id="news" className="lg:px-28 md:px-10 px-4 lg:bg-center lg:bg-no-repeat xl:bg-[length:100%_100%] pt-14 md:pt-16 lg:pt-20 xl:pt-28 flex justify-center items-center">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="md:h-[500px] md:overflow-y-auto text-white space-y-6 pt-0 px-6 scrollable">
          {[...Array(20)].map((_, i) => (

...
export default function Community() {
  return (
    <section id="community" className="lg:px-28 md:px-10 px-4 lg:bg-center lg:bg-no-repeat xl:bg-[length:100%_100%] min-h-screen flex justify-center items-center" style={{ backgroundImage: `url(${background.src})` }}>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="h-96 lg:h-96 md:h-[800] overflow-y-auto text-white space-y-6">
          {[...Array(8)].map((_, i) => (
